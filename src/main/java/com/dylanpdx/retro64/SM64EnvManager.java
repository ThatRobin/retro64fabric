...
public class SM64EnvManager {
    ...
    public static void updateControls(Vec3 cam_fwd,Vec3 camPos,float joystickMult, boolean act_pressed,boolean jump_pressed, boolean crouch_pressed,
        ...
        Vec2 v2=null;
        if (Retro64Client.hasControllerSupport && (clientControllerEvents.input.x>0 || clientControllerEvents.input.y>0)){
    ...
    public static File getROMFile(){
        ...
        try{
            File configuredROMPath=new File(Retro64Config.ROM_PATH);
                ...
                while (!valid){
                    ...
                    if (returnVal == JFileChooser.APPROVE_OPTION) {
                        ...
                        if (createSha1String(file).equals(ROM_HASH)) {
                            Retro64Config.ROM_PATH = file.getAbsolutePath();
                            return file;
                        }else{
        ...
        Retro64Config.ROM_PATH = files[0].toPath().toString();
        return files[0];
    }
