...
public interface Libsm64Library extends Library {
	...
	void sm64_global_init(ByteBuffer rom,ByteBuffer outTexture, SM64DebugPrintFunctionPtr debugPrintFunction);
	void sm64_global_init_audioBin(ByteBuffer rom,ByteBuffer audioData,ByteBuffer outTexture, SM64DebugPrintFunctionPtr debugPrintFunction);
